"""Marketplace options end-of-day data.

Endpoint: ``GET /mp/unicornbay/options/eod``
"""
...
class EodAPI(BaseAPI):
    """Fetch end-of-day options data from the Unicorn Bay marketplace."""
    ...
    def get(
        ...
        *,
        ...
        """Return end-of-day options data.
        ...
        if fields is not None:
            if isinstance(fields, list):
                params["fields[options-eod]"] = ",".join(fields)
            else:
                params["fields[options-eod]"] = fields
        if compact is not None:
            params["compact"] = compact

        return self._get("mp/unicornbay/options/eod", params=params)
