"""PRAAMS equity screener.

Endpoint: ``POST /mp/praams/explore/equity``
"""
...
__all__ = ["ScreenerEquityAPI"]


class ScreenerEquityAPI(BaseAPI):
    """Screen equities using PRAAMS filters."""
    ...
    def search(
        ...
        *,
        ...
        """Return equity screener results.
        ...
        return self._post(
            "mp/praams/explore/equity", params=params, json_body=json_body
        )
