...
Endpoint: ``GET /mp/illio/chapters/risk/{id}``
"""
...
__all__ = ["RiskReturnAPI"]

_VALID_INDEX_IDS = {"SnP500", "DJI", "NDX"}


class RiskReturnAPI(BaseAPI):
    """Fetch risk-return data for an index."""

    def get(
        self,
        index_id: str,
    ) -> dict[str, Any]:
        """Return risk-return data.
        ...
        return self._get("mp/illio/chapters/risk", index_id)
